...
def algorithm(robot, time, events):
    ...
    def RT():
        global is_yellow
        print("Made it 11111111111111111111111111111111111111111111111111111111111111111111111")
        if (isColorInSplit(camera[0], blue)):
            print("Made it 222222222222222222222222222222222222222222222222222222222222")
            return "leftTurn"
        if (isColorInSplit(camera[0], yellow) == True):
            print("Made it 333333333333333333333333333333333333333333333333333333333333")
            is_yellow = True
            robot.move(sped,sped)
            #if (isColorInSplit(camera[1], blue) == True):
            ...
            robot.constantRotate(-sped)
        elif (isColorInSplit(camera[2], yellow) == True and isColorInSplit(camera[1], yellow) == False):
            robot.constantRotate(sped*.5)  
        elif (isColorInSplit(camera[2], yellow) == True and isColorInSplit(camera[1], yellow) == False):
            robot.constantRotate(sped*.5)  
        else:
            robot.move(sped,sped)
...
course.circle(x=30,y=90,r=2,c=green)
